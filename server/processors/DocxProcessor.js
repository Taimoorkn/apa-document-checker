    ...
    try {
      ...
      paragraphs.forEach((para, index) => {
        ...
        if (pPr) {
          ...
          // Indentation - enhanced detection
          const ind = pPr['w:ind'];
          if (ind && ind.$) {
            const attrs = ind.$;
            ...
            console.log(`📐 Indentation found for paragraph ${index}:`, paraFormatting.indentation);
          } else {
            // Check if this is a body paragraph that should have first-line indent
            ...
            paraFormatting.indentation = {
              firstLine: isBodyParagraph ? 0.5 : null, // Default APA first-line indent for body paragraphs
              hanging: null,
              left: null,
              right: null
            };
